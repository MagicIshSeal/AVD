...
AC1_lon_coef = struct('C_L', 0.3356, 'C_D', 0.009, 'C_L_a', 5.55, 'C_D_a', 0.173, ...
    'C_m_a', -1.49, 'C_L_da', -1.53, 'C_m_da', -6.05, 'C_L_hq', 7.83, 'C_m_hq', -35.6, ...
...
% YOUR AIRCRAFT/Aircraft Parameters and Constants Structure 
AC2_lon_coef = struct('C_L', 0.3358, 'C_D', 0.01, 'C_L_a', 5.58, 'C_D_a', 0.170, ...
...
Names = {'Base','Adjusted Iyy', 'Tail Further'}; % Store names for plot legends
